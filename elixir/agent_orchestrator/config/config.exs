...
config :agent_orchestrator,
  ...
  # Keep retry identity for 24 hours. This exceeds the 30-minute maximum child
  # runtime and the five-minute result window, so a normal retry cannot outlive
  # the execution it protects. Expired rows are swept by SpawnGate.
