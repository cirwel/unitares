defmodule Wave3aHandlers.HTTPRouter do
  ...
  RFC `docs/proposals/archive/beam-wave-3a-read-only-handlers.md` v0.2 §2.2 pins the
  ...
  post "/v1/handlers/:tool_name" do
    ...
    case Map.fetch(@handler_modules, tool_name) do
      {:ok, handler_module} ->
        {:ok, body, status} = handler_module.call(arguments)
