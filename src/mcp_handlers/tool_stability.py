...
_TOOL_ALIASES: Dict[str, ToolAlias] = {
    ...
    "record_result": ToolAlias(
        ...
        migration_note=(
            ...
            "digest envelope and adds the raw payload under raw_governance when "
            "response_mode='full' or include_semantics=true is passed, or when "
            "the write returned no outcome_id. "
            f"{EISV_INLINE_SUMMARY}"
        ),
        experience=True),
