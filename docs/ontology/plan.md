...
OPEN — actionable
  ...
  S21-b    items 5–8 audit + close: consolidate dual resolve_session_identity call sites, registered-agent core.identities lookup, honest identity_resolution_outcome split, rejected-explicit-csi audit emission
