...
OPEN — actionable
  ...
  S7       KG provenance migration — schema decision v0.1 landed 2026-05-06; next action is `provenance_chain` persistence round-trip, then authoritative chain snapshot builder from `core.identities`.
