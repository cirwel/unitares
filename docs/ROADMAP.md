...
- Run a validation cohort of **independent draws** with a preregistered protocol,
  ...
  was ratified 2026-09-25 as a pre-read clarification in the registered stop
  rule (`docs/proposals/registered/eisv-outcome-grounding-stop-rule-v0.md`,
...
- Submit the NeMo Relay integration upstream as a NeMo Agent Toolkit plugin
  ...
  [`proposals/active/execute-plane-design-read-v0.md`](proposals/active/execute-plane-design-read-v0.md),
  ...
  [`proposals/active/relay-substrate-relayering-v0.md`](proposals/active/relay-substrate-relayering-v0.md)
