...
| `UNITARES_IDENTITY_STRICT` | varies: `'log'` (config/governance_config.py:1613); `IDENTITY_STRICT_MODE` (config/governance_config.py:1622) | Runtime accessor — respects env changes set after module load | config/governance_config.py |
...
| `UNITARES_IPUA_PIN_CHECK` | varies: `'strict'` (config/governance_config.py:1735); `IPUA_PIN_CHECK_MODE` (config/governance_config.py:1746) | Runtime accessor — respects env changes set after module load | config/governance_config.py |
...
| `UNITARES_PREFIX_BIND_FINGERPRINT` | varies: `'off'` (config/governance_config.py:1697); `PREFIX_BIND_FINGERPRINT_MODE` (config/governance_config.py:1706) | Runtime accessor — respects env changes set after module load | config/governance_config.py |
...
| `UNITARES_SESSION_FINGERPRINT_CHECK` | varies: `'log'` (config/governance_config.py:1649); `SESSION_FINGERPRINT_CHECK_MODE` (config/governance_config.py:1660) | Runtime accessor — respects env changes set after module load | config/governance_config.py |
