...
| `UNITARES_KG_PROACTIVE_EVERY` | `'0'` | Additional cadence gate for opt-in check-in recall (`include_memory_suggestions=true`); never enables injection by itself | src/mcp_handlers/updates/enrichments.py |
