...
| `UNITARES_IDENTITY_STRICT` | varies: `'log'` (config/governance_config.py:1559); `IDENTITY_STRICT_MODE` (config/governance_config.py:1568) | Runtime accessor — respects env changes set after module load | config/governance_config.py |
...
| `UNITARES_IPUA_PIN_CHECK` | varies: `'strict'` (config/governance_config.py:1681); `IPUA_PIN_CHECK_MODE` (config/governance_config.py:1692) | Runtime accessor — respects env changes set after module load | config/governance_config.py |
...
| `UNITARES_PREFIX_BIND_FINGERPRINT` | varies: `'off'` (config/governance_config.py:1643); `PREFIX_BIND_FINGERPRINT_MODE` (config/governance_config.py:1652) | Runtime accessor — respects env changes set after module load | config/governance_config.py |
...
| `UNITARES_SESSION_FINGERPRINT_CHECK` | varies: `'log'` (config/governance_config.py:1595); `SESSION_FINGERPRINT_CHECK_MODE` (config/governance_config.py:1606) | Runtime accessor — respects env changes set after module load | config/governance_config.py |
