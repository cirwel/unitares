...
| `UNITARES_IDENTITY_STRICT` | varies: `'log'` (config/governance_config.py:1618); `IDENTITY_STRICT_MODE` (config/governance_config.py:1627) | Runtime accessor — respects env changes set after module load | config/governance_config.py |
...
| `UNITARES_IPUA_PIN_CHECK` | varies: `'strict'` (config/governance_config.py:1740); `IPUA_PIN_CHECK_MODE` (config/governance_config.py:1751) | Runtime accessor — respects env changes set after module load | config/governance_config.py |
...
| `UNITARES_PREFIX_BIND_FINGERPRINT` | varies: `'off'` (config/governance_config.py:1702); `PREFIX_BIND_FINGERPRINT_MODE` (config/governance_config.py:1711) | Runtime accessor — respects env changes set after module load | config/governance_config.py |
...
| `UNITARES_SESSION_FINGERPRINT_CHECK` | varies: `'log'` (config/governance_config.py:1654); `SESSION_FINGERPRINT_CHECK_MODE` (config/governance_config.py:1665) | Runtime accessor — respects env changes set after module load | config/governance_config.py |
