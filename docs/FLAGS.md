...
| `UNITARES_AGENT_LOCK_BACKEND` | `'advisory'` | Remove agent lock files that no process holds; report the held ones. | src/mcp_handlers/admin/handlers.py, src/state_locking.py |
