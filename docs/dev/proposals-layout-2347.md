...
The root directory has nine files: the guide and eight compatibility locators.
...
The migration inventory records the preserved files and their hashes.
...
The pilot's reader check asks an independent reviewer to locate the product
definition, architecture, active research, frozen experiments, and historical
negative results from the new guide. Record their paths and any confusion in
the PR review. This is a navigation check, not a measured user study or a
file-count success metric.
