...
| `leave_note` | `src/mcp_handlers/knowledge/handlers.py:3908 handle_leave_note` | `src/mcp_handlers/schemas/knowledge.py:301 LeaveNoteParams` | 10s | deprecated→`knowledge` |
...
| `search_knowledge_graph` | `src/mcp_handlers/knowledge/handlers.py:2496 handle_search_knowledge_graph` | `src/mcp_handlers/schemas/knowledge.py:80 SearchKnowledgeGraphParams` | 15s | identity=pre_onboard |
...
| Action | Delegate | Remaps |
|---|---|---|
| `audit` | `src/mcp_handlers/knowledge/handlers.py:4123 handle_audit_knowledge_graph` | — |
| `cleanup` | `src/mcp_handlers/knowledge/handlers.py:3923 handle_cleanup_knowledge_graph` | — |
| `details` | `src/mcp_handlers/knowledge/handlers.py:3230 handle_get_discovery_details` | — |
| `get` | `src/mcp_handlers/knowledge/handlers.py:2514 handle_get_knowledge_graph` | — |
| `list` | `src/mcp_handlers/knowledge/handlers.py:2617 handle_list_knowledge_graph` | — |
| `note` | `src/mcp_handlers/knowledge/handlers.py:3867 handle_knowledge_note` | `content`→`summary` |
| `search` | `src/mcp_handlers/knowledge/handlers.py:2496 handle_search_knowledge_graph` | `query`→`search_query` |
| `stats` | `src/mcp_handlers/knowledge/handlers.py:4029 handle_get_lifecycle_stats` | — |
| `store` | `src/mcp_handlers/knowledge/handlers.py:1388 handle_store_knowledge_graph` | `content`→`details` |
| `supersede` | `src/mcp_handlers/knowledge/handlers.py:4080 handle_supersede_discovery` | — |
| `synthesize` | `src/mcp_handlers/knowledge/handlers.py:3957 handle_synthesize_knowledge_graph` | — |
| `update` | `src/mcp_handlers/knowledge/handlers.py:3211 handle_update_discovery_status_graph` | `content`→`details` |
