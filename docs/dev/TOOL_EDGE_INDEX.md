...
- Audit bundle: `sha256:54aba26f6b5ac657cc30e3fa3a8b73a835a786aa71668031da3980375af6b4d0` (`unitares.tool-surface-audit.v1`).
- Dispatch snapshot: `sha256:28afd82ee869d03519ee81ea6c523cc34e30e8881bff7b9bcb9e92025412d28c`.
- Audited source revision: `sha256:e84e419f9e4db6210e49f2112430a7f21901d1a865e080e01880a730a9520eb0` (52 files).
...
| `call_model` | `src/mcp_handlers/support/model_inference.py:624 handle_call_model` | `src/mcp_handlers/schemas/core.py:544 CallModelParams` | 240s | — |
...
| `reassign_reviewer` | `src/mcp_handlers/dialectic/handlers.py:3258 handle_reassign_reviewer` | `src/mcp_handlers/schemas/dialectic.py:177 ReassignReviewerParams` | 15s | — |
| `record_progress_pulse` | `src/mcp_handlers/resident_progress.py:20 handle_record_progress_pulse` | — | 5s | — |
| `request_dialectic_review` | `src/mcp_handlers/dialectic/handlers.py:1236 handle_request_dialectic_review` | `src/mcp_handlers/schemas/dialectic.py:5 RequestDialecticReviewParams` | 105s | — |
...
| `submit_antithesis` | `src/mcp_handlers/dialectic/handlers.py:2556 handle_submit_antithesis` | `src/mcp_handlers/schemas/dialectic.py:73 SubmitAntithesisParams` | 10s | — |
| `submit_synthesis` | `src/mcp_handlers/dialectic/handlers.py:2764 handle_submit_synthesis` | `src/mcp_handlers/schemas/dialectic.py:106 SubmitSynthesisParams` | 15s | — |
| `submit_thesis` | `src/mcp_handlers/dialectic/handlers.py:2236 handle_submit_thesis` | `src/mcp_handlers/schemas/dialectic.py:64 SubmitThesisParams` | 90s | — |
...
| Action | Delegate | Remaps |
|---|---|---|
| `antithesis` | `src/mcp_handlers/dialectic/handlers.py:2556 handle_submit_antithesis` | — |
| `get` | `src/mcp_handlers/dialectic/handlers.py:1601 handle_get_dialectic_session` | — |
| `list` | `src/mcp_handlers/dialectic/handlers.py:1821 handle_list_dialectic_sessions` | — |
| `quick` | `src/mcp_handlers/dialectic/handlers.py:383 handle_quick_dialectic` | — |
| `reassign` | `src/mcp_handlers/dialectic/handlers.py:3258 handle_reassign_reviewer` | — |
| `request` | `src/mcp_handlers/dialectic/handlers.py:1236 handle_request_dialectic_review` | — |
| `synthesis` | `src/mcp_handlers/dialectic/handlers.py:2764 handle_submit_synthesis` | — |
| `thesis` | `src/mcp_handlers/dialectic/handlers.py:2236 handle_submit_thesis` | — |
