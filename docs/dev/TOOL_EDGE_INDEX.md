...
| `reassign_reviewer` | `src/mcp_handlers/dialectic/handlers.py:2801 handle_reassign_reviewer` | `src/mcp_handlers/schemas/dialectic.py:149 ReassignReviewerParams` | 15s | — |
...
| `submit_antithesis` | `src/mcp_handlers/dialectic/handlers.py:2235 handle_submit_antithesis` | `src/mcp_handlers/schemas/dialectic.py:73 SubmitAntithesisParams` | 10s | — |
| `submit_synthesis` | `src/mcp_handlers/dialectic/handlers.py:2427 handle_submit_synthesis` | `src/mcp_handlers/schemas/dialectic.py:96 SubmitSynthesisParams` | 15s | — |
...
| Action | Delegate | Remaps |
|---|---|---|
| `antithesis` | `src/mcp_handlers/dialectic/handlers.py:2235 handle_submit_antithesis` | — |
...
| `reassign` | `src/mcp_handlers/dialectic/handlers.py:2801 handle_reassign_reviewer` | — |
| `request` | `src/mcp_handlers/dialectic/handlers.py:1127 handle_request_dialectic_review` | — |
| `synthesis` | `src/mcp_handlers/dialectic/handlers.py:2427 handle_submit_synthesis` | — |
