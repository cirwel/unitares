...
| `search_knowledge_graph` | `src/mcp_handlers/knowledge/handlers.py:2574 handle_search_knowledge_graph` | `src/mcp_handlers/schemas/knowledge.py:80 SearchKnowledgeGraphParams` | 15s | identity=pre_onboard |
...
| Action | Delegate | Remaps |
|---|---|---|
| `audit` | `src/mcp_handlers/knowledge/handlers.py:4201 handle_audit_knowledge_graph` | — |
| `cleanup` | `src/mcp_handlers/knowledge/handlers.py:4001 handle_cleanup_knowledge_graph` | — |
| `details` | `src/mcp_handlers/knowledge/handlers.py:3308 handle_get_discovery_details` | — |
| `get` | `src/mcp_handlers/knowledge/handlers.py:2592 handle_get_knowledge_graph` | — |
| `list` | `src/mcp_handlers/knowledge/handlers.py:2695 handle_list_knowledge_graph` | — |
| `note` | `src/mcp_handlers/knowledge/handlers.py:3945 handle_knowledge_note` | `content`→`summary` |
| `search` | `src/mcp_handlers/knowledge/handlers.py:2574 handle_search_knowledge_graph` | `query`→`search_query` |
| `stats` | `src/mcp_handlers/knowledge/handlers.py:4107 handle_get_lifecycle_stats` | — |
| `store` | `src/mcp_handlers/knowledge/handlers.py:1389 handle_store_knowledge_graph` | `content`→`details` |
| `supersede` | `src/mcp_handlers/knowledge/handlers.py:4158 handle_supersede_discovery` | — |
| `synthesize` | `src/mcp_handlers/knowledge/handlers.py:4035 handle_synthesize_knowledge_graph` | — |
| `update` | `src/mcp_handlers/knowledge/handlers.py:3289 handle_update_discovery_status_graph` | `content`→`details` |
