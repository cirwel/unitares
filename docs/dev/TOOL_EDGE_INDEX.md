...
| `submit_antithesis` | `src/mcp_handlers/dialectic/handlers.py:2291 handle_submit_antithesis` | `src/mcp_handlers/schemas/dialectic.py:73 SubmitAntithesisParams` | 10s | — |
| `submit_synthesis` | `src/mcp_handlers/dialectic/handlers.py:2483 handle_submit_synthesis` | `src/mcp_handlers/schemas/dialectic.py:96 SubmitSynthesisParams` | 15s | — |
| `submit_thesis` | `src/mcp_handlers/dialectic/handlers.py:2027 handle_submit_thesis` | `src/mcp_handlers/schemas/dialectic.py:64 SubmitThesisParams` | 90s | — |
...
| Action | Delegate | Remaps |
|---|---|---|
| `antithesis` | `src/mcp_handlers/dialectic/handlers.py:2291 handle_submit_antithesis` | — |
