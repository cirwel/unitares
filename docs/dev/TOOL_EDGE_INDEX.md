...
| `knowledge` | `src/mcp_handlers/consolidated.py:175 action_router` | `src/mcp_handlers/schemas/knowledge.py:341 KnowledgeParams` | 120s | — |
| `leave_note` | `src/mcp_handlers/knowledge/handlers.py:3948 handle_leave_note` | `src/mcp_handlers/schemas/knowledge.py:305 LeaveNoteParams` | 10s | deprecated→`knowledge` |
...
| `reassign_reviewer` | `src/mcp_handlers/dialectic/handlers.py:2999 handle_reassign_reviewer` | `src/mcp_handlers/schemas/dialectic.py:168 ReassignReviewerParams` | 15s | — |
...
| `search_knowledge_graph` | `src/mcp_handlers/knowledge/handlers.py:2536 handle_search_knowledge_graph` | `src/mcp_handlers/schemas/knowledge.py:80 SearchKnowledgeGraphParams` | 15s | identity=pre_onboard |
...
| `submit_antithesis` | `src/mcp_handlers/dialectic/handlers.py:2395 handle_submit_antithesis` | `src/mcp_handlers/schemas/dialectic.py:73 SubmitAntithesisParams` | 10s | — |
| `submit_synthesis` | `src/mcp_handlers/dialectic/handlers.py:2593 handle_submit_synthesis` | `src/mcp_handlers/schemas/dialectic.py:106 SubmitSynthesisParams` | 15s | — |
| `submit_thesis` | `src/mcp_handlers/dialectic/handlers.py:2131 handle_submit_thesis` | `src/mcp_handlers/schemas/dialectic.py:64 SubmitThesisParams` | 90s | — |
...
| Action | Delegate | Remaps |
|---|---|---|
| `antithesis` | `src/mcp_handlers/dialectic/handlers.py:2395 handle_submit_antithesis` | — |
...
| `reassign` | `src/mcp_handlers/dialectic/handlers.py:2999 handle_reassign_reviewer` | — |
| `request` | `src/mcp_handlers/dialectic/handlers.py:1127 handle_request_dialectic_review` | — |
| `synthesis` | `src/mcp_handlers/dialectic/handlers.py:2593 handle_submit_synthesis` | — |
| `thesis` | `src/mcp_handlers/dialectic/handlers.py:2131 handle_submit_thesis` | — |
...
| Action | Delegate | Remaps |
|---|---|---|
| `audit` | `src/mcp_handlers/knowledge/handlers.py:4163 handle_audit_knowledge_graph` | — |
| `cleanup` | `src/mcp_handlers/knowledge/handlers.py:3963 handle_cleanup_knowledge_graph` | — |
| `details` | `src/mcp_handlers/knowledge/handlers.py:3270 handle_get_discovery_details` | — |
| `get` | `src/mcp_handlers/knowledge/handlers.py:2554 handle_get_knowledge_graph` | — |
| `list` | `src/mcp_handlers/knowledge/handlers.py:2657 handle_list_knowledge_graph` | — |
| `note` | `src/mcp_handlers/knowledge/handlers.py:3907 handle_knowledge_note` | `content`→`summary` |
| `search` | `src/mcp_handlers/knowledge/handlers.py:2536 handle_search_knowledge_graph` | `query`→`search_query` |
| `stats` | `src/mcp_handlers/knowledge/handlers.py:4069 handle_get_lifecycle_stats` | — |
| `store` | `src/mcp_handlers/knowledge/handlers.py:1389 handle_store_knowledge_graph` | `content`→`details` |
| `supersede` | `src/mcp_handlers/knowledge/handlers.py:4120 handle_supersede_discovery` | — |
| `synthesize` | `src/mcp_handlers/knowledge/handlers.py:3997 handle_synthesize_knowledge_graph` | — |
| `update` | `src/mcp_handlers/knowledge/handlers.py:3251 handle_update_discovery_status_graph` | `content`→`details` |
