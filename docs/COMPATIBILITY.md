...
| Published server/container | `v2.22.1` | Verified installation baseline retained while the v2.22.0 Compose correction is prepared. v2.22.0 is published but does not contain #2092; see the [errata](releases/2.22.0-errata.md). Advance install pins only after the corrected tag, release page, and container are verified. |
