...
|---|---|---|---|
| `docs/evaluations/orientation-constraint-set/result-v0.md` + `docs/proposals/orientation-constraint-set-preregistration-v0.md` | Paired, information-matched protocol for testing whether a read-only diagnostic constraint set improves source-justified next-action selection without becoming an authority or actuator | Cohort v0 aborted after 16/16 canary parse failures and before all 240 scored calls; no registered result; a separately enrolled v1 plumbing correction is pending | current (2026-08-24) |
