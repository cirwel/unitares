...
| `docs/evaluations/relational-calibration-instrument-supply/result-v1.md` + `docs/proposals/registered/relational-calibration-maturity-capacity-v1.md` | One-time frozen read of whether at least 200 recently active process identities carry temporally established, same-instrument, internally consistent EISV telemetry (instrument supply, not participant capacity) | `instrument_supply_not_ready`: `strict_supply = 0` (953 recent, 38 behaviorally mature, 0 temporally established); the stop rule closes the attempt | current (2026-09-23) |
