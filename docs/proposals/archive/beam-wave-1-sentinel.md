...
**Parent:** `docs/proposals/active/beam-footprint-roadmap-v0.md` v0.3 / v0.3.1 (operator-decision migration commit + council fold).
**Sibling:** `docs/proposals/active/surface-lease-plane-v0.md` (Phase A complete, BEAM service running on `127.0.0.1:8788`).
...
- **Parent roadmap:** `docs/proposals/active/beam-footprint-roadmap-v0.md` (v0.3 + v0.3.1).
- **Boundary pattern source:** `docs/proposals/active/surface-lease-plane-v0.md` Phase A.
