...
- Wave 1 status roll-up: `docs/proposals/archive/wave-1-completion-status-2026-06-14.md`
- RFC parity bindings: `docs/proposals/archive/beam-wave-1-sentinel.md` §B2 (v0.1.1),
