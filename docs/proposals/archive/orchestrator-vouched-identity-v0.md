...
Appendix "Substrate-Earned Identity"); `docs/proposals/archive/s19-attestation-mechanism.md`;
`docs/proposals/active/agent-orchestrator-beam-v0.md`; issues #807, #810, #805 (S19 substrate-gate).
