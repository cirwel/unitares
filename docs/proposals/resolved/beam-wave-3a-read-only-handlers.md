...
**Implementation precedent (BEAM listener supervision, outbound-only):** `docs/proposals/resolved/beam-wave-1-sentinel.md` — `com.unitares.sentinel-beam` PID 1782, no inbound HTTP surface.
...
- `docs/proposals/resolved/beam-wave-1-sentinel.md` — sibling Elixir app pattern; outbound-only.
