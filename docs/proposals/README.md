...
| [`kg-agent-adoption-pilot-v0.md`](kg-agent-adoption-pilot-v0.md) | DRAFT — governed review held production/plumbing claims; a content-addressed offline-fixture canary now passes with strict result binding and exact/private exit restore, while enrollment, live KG parity, scored runs, and live actuators remain unauthorized |
