...
| [`relational-calibration-pilot-v0.md`](relational-calibration-pilot-v0.md) | v0.1 specification and adversarial threat model only — maturity-gates a consent-first future-reference experiment; runtime collection remains explicitly blocked pending capacity, privacy evidence, and fresh operator approval |
| [`relational-calibration-maturity-capacity-v0.md`](relational-calibration-maturity-capacity-v0.md) | Frozen, one-time aggregate feasibility read for a mature, provenance-compatible cohort; documentation only, with no collector, schedule, identities, or enrollment authority |
