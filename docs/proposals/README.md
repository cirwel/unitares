...
| [`kg-agent-adoption-pilot-v0.md`](kg-agent-adoption-pilot-v0.md) | DRAFT / plumbing-only — seven-cell read-only shared-memory adoption experiment, synchronous delegation and shadow-alert gates, plus a neutral exit proof; no scored run or live actuator authorized |
