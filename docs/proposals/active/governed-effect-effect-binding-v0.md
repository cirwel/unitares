...
exists as a reviewed RFC: **`docs/proposals/archive/orchestrator-vouched-identity-v0.md`**
...
- Custody-by-delegation primitive: `docs/proposals/archive/orchestrator-vouched-identity-v0.md` (#827)
