...
rfc_baseline: docs/proposals/active/surface-lease-plane-v0.md @ v0.11+ (post-Phase-A amendments: §7.5 v0.9, §7.2.8/9 v0.10, §7.13 v0.11)
authored: 2026-04-30
phase_a_complete: 2026-05-03
follow_on: docs/proposals/active/beam-footprint-roadmap-v0.md (Read A — what BEAM does next, post-Phase-A)
---
