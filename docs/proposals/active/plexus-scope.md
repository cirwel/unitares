...
|---|---|---|---|
| `repo://unitares/docs/proposals/active/plexus-scope.md` | `file://$HOME/projects/unitares/docs/proposals/active/plexus-scope.md` | Canonical Plexus boundary | This document; one holder at a time for edits |
| `repo://unitares/docs/proposals/active/surface-lease-plane-v0.md` | `file://$HOME/projects/unitares/docs/proposals/active/surface-lease-plane-v0.md` | Lease-plane contract/RFC | Existing canonical implementation contract |
| `repo://unitares/docs/proposals/active/surface-lease-plane-phase-a-plan.md` | `file://$HOME/projects/unitares/docs/proposals/active/surface-lease-plane-phase-a-plan.md` | Phase A staging plan | Implementation sequencing |
