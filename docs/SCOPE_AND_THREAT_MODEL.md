...
the independent behavioral signal telemetry-only. On MCP check-ins a
...
[`proposals/active/dialectic-resolution-receipt-v0.md`](proposals/active/dialectic-resolution-receipt-v0.md).
