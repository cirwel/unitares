...
window.SNAPSHOT = {
  ...
  residentPanels: {
    watcher: { total:81, byStatus:{ dismissed:54, confirmed:17, surfaced:5, aged_out:5 }, openSev:{ high:3, medium:2 },
      resident:{ status:"healthy", silence:44, silenceThreshold:172800, coherence:0.484, risk:0.15, verdict:"proceed", updates:10203, recent:[] },
    ...
    sentinel: { total:22, bySeverity:{ medium:14, high:8 },
      resident:{ status:"healthy", silence:269, silenceThreshold:1800, coherence:0.482, risk:0.15, verdict:"proceed", updates:29303, recent:[] },
    ...
    vigil: { cycles24h:42, lastVerdict:"proceed", lastCycleAgeS:890, avgCoherence:0.489,
      eisv:{E:0.750,I:0.766,S:0.159,V:-0.017,coherence:0.489},
      resident:{ status:"healthy", silence:890, silenceThreshold:3600, coherence:0.482, risk:0.0,
        verdict:"guide", updates:5392, eisv:{E:0.727,I:0.756,S:0.199,V:-0.029},
        recent:[{type:"note",summary:"Groundskeeper: 13 stale, 0 archived",timestamp:"2026-06-19T09:20:22Z"},
          {type:"note",summary:"Groundskeeper: 12 stale, 0 archived",timestamp:"2026-06-17T12:50:21Z"}] } },
    // Same shape as every other resident row — `recent` is the write LIST the
    // server returns (capped at 5) and `updates` the durable check-in count.
    // The old fixture carried a numeric `writes`, which is why the live
    // "[object Object]" cell never showed up in snapshot mode.
