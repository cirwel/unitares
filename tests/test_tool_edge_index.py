...
def test_wire_catalog_raises_for_an_absent_dependency_and_records_a_tree_defect(monkeypatch):
    ...
    tools, aliases, import_failures, unbound = tei.collect()
    ...
    assert codes == ["EXPOSURE_COLLECTION_FAILURE"], codes
