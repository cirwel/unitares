...
```bash
pip install "unitares-sdk @ git+https://github.com/cirwel/unitares@v2.22.1#subdirectory=agents/sdk"
```

Replace `@v2.22.1` with another server release tag only after checking the
