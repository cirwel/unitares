...
```bash
pip install "unitares-sdk @ git+https://github.com/cirwel/unitares@v2.18.0#subdirectory=agents/sdk"
```

Replace `@v2.18.0` with another server release tag only after checking the
