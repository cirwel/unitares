...
def main(argv: list[str] | None = None) -> int:
    ...
    if (
        ...
        if _watcher_findings_lease_mode() == "enforce":
            ...
            # be satisfied. Preserve the operator's no-mutation guarantee and
            # deliver read-only context; a later non-hook lifecycle call can
            # persist the receipt under the remote lease.
